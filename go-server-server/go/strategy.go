...
type Strategy struct {
	...
	OperationSchemaAddress *IpfsAddress `json:"OperationSchemaAddress"`

	StopConditionAddress *IpfsAddress `json:"StopConditionAddress"`

	TokenStrategyAddress *IpfsAddress `json:"TokenStrategyAddress"`
}
