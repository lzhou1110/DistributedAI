...
6. If you did everything correct, https://lzhou1110.github.io/DistributedAI/ will lead to your new docs
...
- Documentation(ReDoc): https://lzhou1110.github.io/DistributedAI/
- SwaggerUI: https://lzhou1110.github.io/DistributedAI/swagger-ui/
- Look full spec:
    + JSON https://lzhou1110.github.io/DistributedAI/swagger.json
    + YAML https://lzhou1110.github.io/DistributedAI/swagger.yaml
- Preview spec version for branch `[branch]`: https://lzhou1110.github.io/DistributedAI/preview/[branch]
...
1. Run `npm start`
2. Checkout console output to see where local server is started. You can use all [links](#links) (except `preview`) by replacing https://lzhou1110.github.io/DistributedAI/ with url from the message: `Server started <url>`
