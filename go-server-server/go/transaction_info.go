...
type TransactionInfo struct {
	...
	DataSchemaAddress *IpfsAddress `json:"DataSchemaAddress"`

	MetadataAddress *IpfsAddress `json:"MetadataAddress"`

	ModelAddress *IpfsAddress `json:"ModelAddress"`

	StrategyAddress *IpfsAddress `json:"StrategyAddress"`

	ComputionAddress *IpfsAddress `json:"ComputionAddress"`
}
