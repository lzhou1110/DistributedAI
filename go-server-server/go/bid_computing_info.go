...
type BidComputingInfo struct {

	OperationSchemasAddress *IpfsAddress `json:"OperationSchemasAddress"`

	ComputingAddress *IpfsAddress `json:"ComputingAddress"`

	PaymentAddress *IpfsAddress `json:"PaymentAddress"`

	ComputerAttributesAddress *IpfsAddress `json:"ComputerAttributesAddress"`
}
